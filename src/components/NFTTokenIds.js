...
import { fallbackImg } from "helpers/fallback";
const { Meta } = Card;
...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  async function purchase() {
    ...
    const ops = {
      contractAddress: "0xB6a1EdB185623eff29E7e85dAd3eE78a08168081",
  ...
  async function updateSoldMarketItem() {
    ...
    await query.get(id).then((obj) => {
      obj.set("sold", true);
      obj.set("owner", "0xB6a1EdB185623eff29E7e85dAd3eE78a08168081");
      obj.save();
    });
  }
